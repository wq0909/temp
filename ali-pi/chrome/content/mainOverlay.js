...
var config = {id: 'pi@etosun.com'};
Firebug.registerExtension('pi', config);
...
Firebug.registerTracePrefix('PI;', 'DBG_PI', true, 'chrome://pi/skin/main.css');

//#overlay chrome://browser/content/browser.xul              chrome://pi/content/toolbarOverlay.xul