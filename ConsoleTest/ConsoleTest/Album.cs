...
namespace ConsoleTest
{
	public class Album
	{
		private JObject AlbumJSON = null;
		public Album()
		{
			...
			this.AlbumJSON = JObject.Parse(jsonString);
			var urlMap = this.AlbumJSON["urlMap"];
			var imageInfos = this.AlbumJSON["imageInfos"];
			var infos = JsonConvert.SerializeObject( imageInfos );
			var photos = JsonConvert.DeserializeObject<List<Photo>>(infos);
